    ...
    <>
      <Container>
        <form
          ...
          className="position-absolute top-50 start-50 translate-middle d-flex flex-column align-items-center justify-content-between"
        >
          <span className="text-primary d-block mb-3 text-uppercase">Shorten your link</span>
          <InputGroup className="mb-3">
            <Form.Control onChange={changeHandler} placeholder="any link you want" value={userInput} />
          </InputGroup>
          <Button type="submit" className="btn btn-primary">
            Shorten!
          </Button>
          <div className="mt-3">
            <span className="text-secondary d-block mb-3">Your link will appear here</span>
            <a href={redirect} className="text-success" target="_blank" rel="noopener noreferrer">
              {redirect}
            </a>
          </div>
        </form>
